...
def evolve2_disable_add_proposal_permission(root, registry):  # pragma: no cover
    """(disabled) Disable add_proposal permissions."""


@log_migration
def evolve3_use_adhocracy_core_title_sheet(root, registry):  # pragma: no cover
...
def evolve4_disable_voting_and_commenting(root, registry):  # pragma: no cover
    """(disabled) Disable rate and comment permissions."""


@log_migration
def change_mercator_type_to_iprocess(root, registry):  # pragma: no cover
...
@log_migration
def add_badge_assignments_services_to_proposal_items(root, registry):  # pragma: no cover
...
@log_migration
def add_badgeable_sheet_to_proposal_versions(root, registry):  # pragma: no cover
...
@log_migration
def add_logbook_service_to_proposal_items(root, registry):  # pragma: no cover
...
@log_migration
def add_haslogbookpool_sheet_to_proposal_versions(root, registry):  # pragma: no cover
    """Add IHasLogbookPool sheet to proposals versions."""
    migrate_new_sheet(root, IMercatorProposalVersion, IHasLogbookPool)


@log_migration
def remove_mercator_workflow_assignment_sheet(root, registry):  # pragma: no cover
...
@log_migration
def make_mercator_proposals_badgeable(root, registry):  # pragma: no cover
...
@log_migration
def reindex_requested_funding(root, registry):  # pragma: no cover
